    ...
    <div class="container">
      <div class="row">
        <div class="col-12 col-md-11">
          <h3>Place list is booking</h3>
        </div>
        <div class="mt-2 row row-cols-1 row-cols-md-4 g-sm-0 g-md-5">
        <?php foreach ($place_is_requested as $element): ?>
          <div class="col">
            <form action="DetailRequest.php" method="post">
              ...
              <?php 
                ...
                $sqltmp2 = "Select * from user where id = $userrent";
                $getuserrent = $conn->query($sqltmp2);
                foreach($getuserrent as $obj){
                    $fullnameUser = $obj["name"];
                }
              ?>
              ...
              ?>
                <input type="submit" name="BookingDetail" class="btn btn-success fst-light py-2 mt-2" value="Paid" style="width: 100%">
              <?php } ?>
            </form>
          </div>
        <?php endforeach; ?>
